#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 python train_DA.py -d digits --source svhn --target mnist -j 0 &
CUDA_VISIBLE_DEVICES=1 python train_DA.py -d digits --source usps --target mnist -j 0 &
CUDA_VISIBLE_DEVICES=2 python train_DA.py -d digits --source mnist --target usps -j 0 &
wait
...
CUDA_VISIBLE_DEVICES=0 python train_SFIT.py -d digits --source svhn --target mnist -j 0 &
CUDA_VISIBLE_DEVICES=1 python train_SFIT.py -d digits --source usps --target mnist -j 0 &
CUDA_VISIBLE_DEVICES=2 python train_SFIT.py -d digits --source mnist --target usps -j 0 &
wait
